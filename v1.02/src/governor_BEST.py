    ...
    while time_elapsed < maximumTime:
        ...
        # ==========================================
            ...
            if targetScoutDistance < 0.5:
                ...
                if not scout_breadcrumbs or distance(currentScoutPosition, scout_breadcrumbs[-1]) > 0.5:
                    scout_breadcrumbs.append(currentScoutPosition)
        ...
        # ==========================================
            ...
            if targetRoverDistance < 0.5:
                ...
                # --- IL VERO VALORE DELLO SCOUT: REPLANNING ---
                # Il Rover calcola il percorso definitivo schivando gli stuck_event!
                if not rover_path:
                    print("Il Rover calcola la rotta finale aggirando le trappole scoperte dallo Scout...")
                    rover_path = get_robust_path(rover_pos, targetPoint, world_map, world_map_stuck)
                    if not rover_path:
                        print("ERRORE: Impossibile trovare una rotta sicura per il Rover!")
                
                # Esecuzione del nuovo percorso
                if rover_path:
                ...
                # Questo if resterà per sicurezza, ma non dovrebbe più scattare mai!
...
def get_robust_path(start_pos, target_pos, world_map, world_map_stuck=None):
    ...
    while open_list and iterations < max_iterations:
        ...
        for dx, dy in directions:
            ...
            # IL CUORE DEL REPLANNING: Ignora i nodi se sono dentro world_map_stuck!
            if neighbor in world_map and neighbor not in world_map_stuck and world_map[neighbor].get('safe', True):
